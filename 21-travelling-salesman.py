...
def calculate_actual_time() -> float:
    """
    :return: time in hours to travel through all cities
...
problem_fit = mlrose.TSPOpt(length = len(city_mapper), fitness_fn = fitness_fn, maximize=False)
